 ...
 *
 */
class DessertTimer(lifecycle: Lifecycle, secondsCount: Int) : LifecycleObserver
{


    init {
        // And DessertPusher(this) as an observer to the MainActivity's lifecycle
        lifecycle.addObserver(this)
    }

    // The number of seconds counted since the timer started
    var secondsCount = secondsCount
